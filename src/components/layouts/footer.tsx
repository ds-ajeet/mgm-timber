...
const Footer = () => {
   ...
   return (
      <>
         <footer 
        style={{background:"#1e293e",color:"white"}} className="footer">
            <div className="container">
        ...
        <form className="form subscribe" novalidate="" action="https://mgmtimber.us15.list-manage.com/subscribe/post?u=385bafbd480f5865266cc45d9&amp;id=afed42f339" method="post" id="mc-embedded-subscribe-form" target="_blank" name="mc-embedded-subscribe-form">
