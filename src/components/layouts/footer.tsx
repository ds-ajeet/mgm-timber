               ...
               <div className="footer_links">
                  <div  className="column pb-4">
                     <a href="/" target="_self"  rel="noreferrer">
                        <img  style={{height:"70px"}}src={pizzaLogo} alt="Logo" className="fadein imgFinal" />
                     </a><br/>
                     <div className="social-media">
                     <div className="">
                        <ul>
                           <li><img src="https://www.mgmtimber.co.uk/static/version1674641584/frontend/mgmtimber/default/en_GB/images/icons/contact.svg" alt="Contact Us"/> <a href="#">Contact Us</a></li>

                           <li><img src="https://www.mgmtimber.co.uk/static/version1674641584/frontend/mgmtimber/default/en_GB/images/icons/get-quote.svg" alt="Get a Quote"/> <a href="#">Get a Quote</a></li>
                           
                           <li><img src="https://www.mgmtimber.co.uk/static/version1674641584/frontend/mgmtimber/default/en_GB/images/icons/find-a-branch.svg" alt="Find a Branch"/> <a title="Branch Locator" href="#">Find a Branch</a></li>
                        </ul>
                     </div>  
                     <div className="jds-group">
            <img loading="lazy" src="https://www.mgmtimber.co.uk/static/version1674641584/frontend/mgmtimber/default/en_GB/images/jd-group.png" alt="Part of the JDS Group" width="274" height="21"/>
        </div> 
                  ...
                  <div className="column">
                     ...
                     <ul>
                        <li><a href="#" title="Careers">Contact Us</a></li>
                  ...
                  <div className="column">
                     <h5>About MGM</h5>
                     <ul>
                        <li><a href="#" title="Main Menu">About Us</a></li>
                        ...
                        <li><a href="#" title="Drinks Menu">News</a></li>
                     </ul>
                  </div>
